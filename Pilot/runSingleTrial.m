...
% Determine delay onset
delayOnset =GetSecs;
if expDes.expMat(t,8) == 0
    tdelay = const.tdelayS;
else
...
%TODO what if the picture hasn't been drawn completely during delay time?
